...
//	assert.NotNil(t, mysqlPools[DefaultPoolCode])
//	assert.Equal(t, DefaultPoolCode, mysqlPools["default"].GetPoolConfig().GetCode())
//	assert.Equal(t, "test", mysqlPools[DefaultPoolCode].GetPoolConfig().GetDatabase())
//	assert.Equal(t, 5, mysqlPools[DefaultPoolCode].GetPoolConfig().GetVersion())
//	assert.Equal(t, "root:root@tcp(localhost:3311)/test", mysqlPools[DefaultPoolCode].GetPoolConfig().GetDataSourceURI())
//
//	localCachePools := validated.Registry().LocalCachePools()
//	assert.Len(t, localCachePools, 2)
//	assert.NotNil(t, localCachePools[DefaultPoolCode])
//	assert.NotNil(t, localCachePools["another"])
//	assert.Equal(t, DefaultPoolCode, localCachePools[DefaultPoolCode].GetPoolConfig().GetCode())
//	assert.Equal(t, 100, localCachePools[DefaultPoolCode].GetPoolConfig().GetLimit())
